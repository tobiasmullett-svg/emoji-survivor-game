...
export const EVOLVED_WEAPONS: Record<string, WeaponDef> = {
  ...
  smg: { id: 'smg', name: 'Minigun', emoji: '🌀', kind: 'ranged', damage: 8, range: 280, cooldown: 0.08, projCount: 1, spread: 0.18, piercing: false, projEmoji: '·', projSpeed: 480, chainTargets: 0, desc: 'Bullet hell' },
