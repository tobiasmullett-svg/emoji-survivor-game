...
const s = StyleSheet.create({
  ...
  tabRow: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 4 },
  ...
  itemDesc: { color: '#94A3B8', fontSize: 12, textAlign: 'center', marginTop: 4, height: 34 },
  weaponStatsRow: { flexDirection: 'row', gap: 6, marginTop: 4, backgroundColor: 'rgba(0,0,0,0.2)', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  weaponStatText: { color: '#A7F3D0', fontSize: 10, fontWeight: '700' },
  ...
  broodHeader: { marginBottom: 6 },
  broodHint: { color: '#64748B', fontSize: 11, fontWeight: '700', lineHeight: 15 },
  invTitle: { color: '#94A3B8', fontSize: 13, marginTop: 8, marginBottom: 6 },
