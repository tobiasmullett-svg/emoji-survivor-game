...
const s = StyleSheet.create({
  ...
  statLabel: { color: '#CBD5E1', fontSize: 12, width: 52, fontWeight: '700' },
  ...
  statVal: { color: '#E2E8F0', fontSize: 12, fontWeight: '800', width: 38, textAlign: 'right' },
  ...
  abilityDesc: { color: '#CBD5E1', fontSize: 12, marginTop: 2 },
